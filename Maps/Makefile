...
$(NAME) : $(INC) $(OBJ)
	...
	$(CC)  $(OBJ)  $(CFLAGS)  Utils/libft/libft.a -Lmlx_linux -lmlx_Linux -L/usr/lib -Imlx_linux -lXext -lX11 -lm -lz -o $(NAME)

bonus : $(OBJ_BNC)
		make bonus -C Utils/libft
		$(CC)  $(OBJ_BNC)  $(CFLAGS)  Utils/libft/libft.a -Lmlx_linux -lmlx_Linux -L/usr/lib -Imlx_linux -lXext -lX11 -lm -lz -o $(NAME_BNS)
